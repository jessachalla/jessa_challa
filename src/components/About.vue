  ...
  <div>
    <v-container class="about">
      <div class="about-ps mt-10">
        ...
        ></v-img>
        <p class="intro-p">
          <span class="flair">Hey there! </span> I'm Jessa Challa. I'm a
          lifelong Grand Rapids resident and equity advocate. I'm Co-CEO and a
          Software Engineer at a minority and women-owned software company,
        ...
        <p class="intro-p">
          ...
          level of excellence within my field as a successful BIPOC woman in my
          field. I have the ultimate goal of making the tech sector a more
          inviting and inclusive place for all.
        </p>
        <p class="intro-p">
          And what about community work? Well, as a member of the 2020 Cohort of
          Community Catalysts through
          <span class="flair">WMCAT’s Public Agency</span>, I've utilized
          Equity-Centered Design to begin the work to challenge and change
          systems and institutions of power to be more equitable across Grand
          Rapids through strategic projects and initiatives. I also work on
          personal community project to create community resources.
        </p>
        <p class="signature">
